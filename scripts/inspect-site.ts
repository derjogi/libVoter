...
const URL = process.argv[2] || 'https://voteauckland.co.nz/en/information-for-voters/candidates-2025-local-elections.html';
...
async function inspectSite() {
  ...
  for (const el of allElements.slice(0, 200)) { // limit to first 200
  ...
  console.log('Class counts (top):', Object.entries(classCounts).sort((a,b) => b[1] - a[1]).slice(0, 10));
