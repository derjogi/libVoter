...
export const MOCK_RESPONSES: Record<string, string> = {
  COMPONENT_SELECTOR: JSON.stringify({
    ...
    data: {
      ...
      options: [
        { id: 'housing', label: 'Housing', description: 'Affordable housing and rent' },
        { id: 'transport', label: 'Transport', description: 'Public transport and roads' },
        { id: 'climate', label: 'Climate', description: 'Climate change response' },
        { id: 'health', label: 'Health', description: 'Healthcare and hospitals' },
      ],
      maxSelections: 3,
    },
  }),
...
export function pickMockResponse(promptText: string): string {
  ...
  if (promptText.includes('Available component types and their EXACT data structures')) {
